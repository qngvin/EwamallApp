...
import { AppState, BackHandler, Button, Image, ScrollView, StyleSheet, Text, TouchableOpacity, View } from "react-native";
        ...
        <ScrollView style={{ marginHorizontal: 15 }}>
            ...
            {/* <View style={styles.header}>
                <View>
                    ...
                    <Image source={{ uri: 'https://play-lh.googleusercontent.com/l_Lm4yidvp_sfTkoDRdkF0lODJu72jkP4RfPqfPBlrk2X7b2qb0q88BUwt_7QzKSaLY' }} style={styles.image} />
                </View>
                <Text style={{ fontSize: 18, fontWeight: 'bold' }}>NhatRauXanh</Text>
                <Button title="Xem shop" onPress={() => navigation.navigate('Shop' as never)} />
            </View>
